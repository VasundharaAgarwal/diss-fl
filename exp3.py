...
#     metrics_agg["time_cliet_fit_mean"] = np.mean(m["time_fit"] for _, m in metrics)
#     metrics_agg["time_client_fit_mean"] = np.std(m["time_fit"] for _, m in metrics)
...
if __name__ == "__main__":
    ...
    def client_fn(cid: str):
        ...
        if args.dp_enabled:
            client = DPClient(NumPyClientWrapper(client), adaptive_clip_enabled=True)
        return client
