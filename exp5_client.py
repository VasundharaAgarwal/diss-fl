...
class CifarClient(fl.client.Client):
    ...
    def _instantiate_model(self, model_str: str):
        ...
        m = getattr(import_module("exp5_utils"), model_str)
        # instantiate model
        self.model = m()
    ...
    def fit(self, ins: FitIns) -> FitRes:
        ...
        exp5_utils.train(self.model, trainloader, epochs=epochs, device=DEVICE)
    ...
    def evaluate(self, ins: EvaluateIns) -> EvaluateRes:
        ...
        loss, accuracy = exp5_utils.test(self.model, testloader, device=DEVICE)
...
def main() -> None:
    ...
    dp_client = DPClient(client, adaptive_clip_enabled=True)
    fl.client.start_client(args.server_address, dp_client)
